...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm">
            <legend><a href="http://localhost:8080/ShopDeck/test"><i class="glyphicon glyphicon-globe"></i></a> Sign up!</legend>
            ...
            <input  path="contact" class="form-control" name="contact" placeholder="Contact NO" type="text" required="true"/>
