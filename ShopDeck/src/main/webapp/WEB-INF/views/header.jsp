...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="test"><i class="fas fa-shopping-cart"></i>ShopDeck</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <c:if test="${pageContext.request.userPrincipal.name!=null}"><li><a href="userProfile/${pageContext.request.userPrincipal.name}">Hello ${pageContext.request.userPrincipal.name}</a></li></c:if>
         <c:if test="${pageContext.request.userPrincipal.name!=null }">
          ...
          <c:if test="${pageContext.request.userPrincipal.name==null}"><li><a href="${pageContext.request.contextPath}/AddUser"><span class="glyphicon glyphicon-user"></span> Sign UP</a></li></c:if>
...
<li><a href="${pageContext.request.contextPath}/DisplayProduct">Display Product</a></li>
<li><a href="${pageContext.request.contextPath}/addCategory">Add Category</a></li>
<li><a href="${pageContext.request.contextPath}/viewcategory">Display Category</a></li>
